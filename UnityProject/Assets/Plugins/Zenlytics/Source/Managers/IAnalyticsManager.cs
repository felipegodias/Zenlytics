...
namespace Zenlytics.Managers
{
    ...
    public interface IAnalyticsManager
    {
        ...
        void ReportResourceEvent(ResourceType type, string currency, float amount, string itemType, string itemId);
        ...
        void ReportProgressionEvent(ProgressionStatus status, string p01, string p02, string p03, int score);
        ...
        void ReportErrorEvent(ErrorSeverity severity, string message);
        ...
        void ReportDesignEvent(string eventName, float eventValue);
